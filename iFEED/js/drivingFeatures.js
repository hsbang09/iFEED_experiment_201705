...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Experiment: Change the axis name
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Experiment
    var expression = relabel_randomized_variable(d.expression);
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Experiment: Change the tooltip message
    ...
    var fo = tooltip
                    ...
                    .html(function(d){
                        var output= "" + pp_feature(d.expression)+
                        //"<br> Support: " + round_num_fourth_dec(d.metrics[0]) + 
                        "<br><br> Specificity : " + round_num_fourth_dec(d.metrics[2]) + 
                        "<br> Coverage    : " + round_num_fourth_dec(d.metrics[3]) +"";
                        return output;
                    }).style("padding","20px")
